...
if __name__ == "__main__":
    ...
    model_logo = pyglet.model.load("model/church.obj", batch=batch)
    #model_box = pyglet.model.load("model/church.obj", batch=batch)

    circle = pyglet.shapes.Circle(0, 0, 1, batch=batch)

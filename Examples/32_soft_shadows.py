"""
Texturing, Phong lighting and shadow map (with PCF soft shadows) combined.
"""
...
class App(pyglet.window.Window):
    def __init__(self, **kwargs):
        ...
        self.wall_group = TextureGroup(
            pyglet.image.load('res/textures/brick_wall_set/brick_wall_005_diff_2k.jpg').get_texture(), self.program)
    ...
    def create_shadow_fbo(self, shadow_map_slot=GL_TEXTURE1):
        ...
        glActiveTexture(shadow_map_slot)
        glBindTexture(GL_TEXTURE_2D, self.depthMap)

...
class Camera2D:
    ...
    Instantiate, then draw assigned batches in on_draw() method using "with" context manager.
    """
    ...
    def mouse_pan(self, dx, dy):
        """For use with Window's on_mouse_drag(). Simply pass dx, dy arguments."""
        self.move(-dx, -dy)

    def mouse_zoom(self, dy):
        """For use with Window's on_mouse_drag(). Simply pass dy argument."""
...
class Camera3D:
    ...
    def on_resize(self, width, height):
        ...
        self._window.projection = pyglet.math.Mat4.perspective_projection(self.aspect_ratio, 0.1, 3000, self.fov)
